                            ...
                            <div className='rounded-xl border border-light-blue p-6 overflow-auto custom-scrollbar h-[calc(100vh-66px)]'>
                                <ul className="grid grid-cols-3 gap-8">
                                    {items && items?.length > 0 && items?.map((item, index) => (
                                        ...
                                        >
                                            <span className='bg-white relative overflow-hidden rounded-xl block shadow-bookmark border border-dark-blue/30 h-[234px]'>
                                                <span
                                                ...
                                                <img src={item?.image} alt="" className='object-cover object-center h-full w-full' />
                                            </span>
