...
const ImportBookmarks = () => {
    let url = `${process.env.REACT_APP_API_URL}/api/import-bookmark`
    ...
    <div className="p-3 bg-white border border-solid border-gray-300 rounded-xl dark:bg-neutral-800 dark:border-neutral-600">
      <div className="mb-1 flex justify-between items-center">
        ...
        <div className="flex items-center gap-x-2">
          <button type="button" className="text-gray-500 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200" data-hs-file-upload-remove="">
  ...
  <div className="mt-4 space-y-2 empty:mt-0" data-hs-file-upload-previews=""></div>
          ...
          {/* <div className="w-full flex flex-wrap flex-col space-y-4">
            <div
              ...
              <div className="mb-1 flex justify-between items-center">
                <div className="flex items-center gap-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-800 dark:text-white">
                      <span
                        className="truncate inline-block max-w-75 align-bottom"
                        data-hs-file-upload-file-name=""
                      />
                      .<span data-hs-file-upload-file-ext="" />
                    </p>
                    <p
