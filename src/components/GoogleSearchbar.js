...
const GoogleSearchbar = () => {
    ...
    return (
        <form onSubmit={googleFormik.handleSubmit} className="w-1/2 flex items-center rounded-xl shadow-sm mb-4 relative pl-32 bg-white border border-gray-200 w-[calc(100%-375px)]">
