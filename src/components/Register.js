                    ...
                    <div className='w-full py-20 px-10'>
                        ...
                        <div className="max-w-[400px] mx-auto">
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                <div className="mb-5">
                                    <PasswordField need_icon={true} id="registerPassword" setShowPassword={setShowPassword} showPassword={showPassword} name="password" label="Password" type="password" placeholder="" iconPlacement="right" fieldValue={formik.values.password} setFieldValue={formik.handleChange} setFieldValueOnBlur={formik.handleBlur} />
