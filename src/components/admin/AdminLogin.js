            ...
            <div className='w-full py-20 px-10'>
                ...
                <div className="max-w-[400px] mx-auto">
                    ...
                    <div className='text-xl text-light-black text-center'>
                        ...
                        <p className='mb-4'>Don't have an account? <span className="cursor-pointer hover:text-dark-blue">Sign up</span></p>
                        <p><span className='cursor-pointer hover:text-dark-blue'>Forgot your password?</span></p>
                    </div>
                </div>
            </div>
        </div>
