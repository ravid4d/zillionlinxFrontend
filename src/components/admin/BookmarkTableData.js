  ...
  return (
    ...
    <td className="h-px min-w-48 w-48 xl:max-w-72">
      <div className="px-6 py-3 flex flex-wrap flex-col">
        ...
        <Link to={bookmark?.website_url} target="_blank" rel="noopener noreferrer" className="block break-all text-sm text-gray-500 dark:text-neutral-500 group-hover:text-blue-500">
