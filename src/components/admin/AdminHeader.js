  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        setTimeout(() => setSearchField(false), 0);
      }
    };
          ...
          <div className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
            <div className="">
              ...
              {searchField && (
                <div
                  className={`${
                    searchField ? "block" : "hidden"
                  } md:block absolute top-full left-0 right-0 w-full`}
                  ref={searchRef}
                >
                ...
                <div
                  className={`${
                    toggleProfileDropdown
                      ? "hs-dropdown-open:opacity-100 block"
                      : "opacity-0 hidden"
                  } absolute right-0 top-full hs-dropdown-menu transition-[opacity,margin] duration min-w-60 bg-white shadow-md rounded-lg mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full`}
                >
