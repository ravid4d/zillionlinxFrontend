...
const Bookmark = ({
  ...
  return (
    <>
      <span className={`${type==='toplink' ? 'bg-red-400' : 'bg-whtie'} relative overflow-hidden rounded-xl block shadow-bookmark border border-dark-blue/30`}>
      ...
      <span
        onClick={() => handleRemoveItem({ id: item?.id, type: type })}
