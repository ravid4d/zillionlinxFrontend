    ...
    <>
      {
        location.pathname === "/result" ? (
          <div className={`google-search-wrap flex sm:items-center justify-between sm:gap-2 flex-col sm:flex-row bg-white mb-4 relative w-auto py-2 px-2 border border-gray-200 rounded-xl text-md`}>
            {/* <div className="w-full sm:w-auto py-2 px-2 border border-gray-200 rounded-xl text-md flex sm:items-center justify-between sm:gap-2 flex-col sm:flex-row bg-white"> */}
              <p className="text-dark-blue text-lg font-medium">Web Search:</p>
          ...
          (
            <form
              ...
              autoComplete="off"
              className={`flex items-start justify-end gap-4 mb-4 relative  ${location.pathname === "/bookmarks"
                  ? "max-w-full w-full lg:w-[calc(100%-375px)]"
