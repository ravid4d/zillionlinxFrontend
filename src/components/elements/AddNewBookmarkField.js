      ...
      <div className="flex items-center rounded-xl shadow-sm mb-4 relative add-url-to-bookmark xl:w-[350px] max-w-full">
        <div className="relative w-full">
          <input
            ...
            id="url"
            name="url"
            className="h-[48px] py-3 pl-[68px] pr-14 block w-full border-gray-200 rounded-xl text-md placeholder:text-lg placeholder:text-gray-600 placeholder:text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
          />
