  ...
  return (
    <div
      ...
      className={`hs-overlay [--overlay-backdrop:static] ${
        openModal?.login ? "open opened" : "hidden"
          ...
          <div className="w-full py-20 px-10">
            <div className="flex justify-between items-center flex-col max-w-[400px] mx-auto">
              ...
              <button
                ...
                } absolute top-5 right-5 size-9 inline-flex justify-center items-center rounded-full border border-transparent bg-dark-blue text-light-blue focus:outline-none focus:bg-light-blue focus:text-dark-blue" aria-label="Close" data-hs-overlay="#hs-slide-down-animation-modal`}
              >
            ...
            <div className="max-w-[400px] mx-auto">
              <form onSubmit={formik.handleSubmit}>
                ...
                <div className="mb-5 flex items-center gap-2">
                  ...
                  <label
                    htmlFor="remember_me"
                    className="cursor-pointer text-base xl:text-lg text-dark-blue font-medium dark:text-white"
                  >
              ...
              <div className="pt-7 pb-2 flex items-center text-lg text-light-black uppercase before:flex-1 before:border-t before:border-light-black before:me-6 after:flex-1 after:border-t after:border-light-black after:ms-6">
                Or
              </div>
              <div className="text-base xl:text-lg text-light-black text-center">
                ...
                <p className="mb-2">
                  ...
                  <span
                    className="cursor-pointer font-semibold text-dark-blue"
                ...
                <p>
                  <span
                    onClick={() => setWhichModalOpen("forgot")}
